...
Transcription factors (TFs) are proteins that bind a variety of regulatory elements in the genome to regulate transcription of genes. TFs tend to bind DNA is a sequence-specific manner to short DNA sequence motifs. However, in vivo TF binding is affected by a variety of other factors beyond DNA sequence affinity, such as interactions with other TFs, TF concentration, chromatin state and 3D genome architecture [cite:  http://dx.doi.org/10.1016/j.tibs.2014.07.002]. Hence, TFs have highly dynamic binding landscapes across diverse cellular contexts and states. Deciphering accurate context-specific TF binding landscapes is one of the central problems in regulatory genomics. 

A variety of high throughput <i>in vitro</i> and <i>in vivo</i> experimental approaches have been developed to characterize sequence affinity of TFs and map TF binding landscapes [cite:  http://dx.doi.org/10.1016/j.tibs.2014.07.002]. <i>In vitro</i> assays such protein binding microarrays and HT-SELEX provide quantitative measures of binding specificity of a TF to a large library of short olignonucleotides (~20-1000 bp). <i>In vivo</i> assays such as chromatin immunoprecipitation sequencing (ChIP-seq) provide quantatitive read outs of binding of a TF at every nucleotide in the genome.

Transcription factors (TFs) and RNA-binding proteins are key components in gene regulation and higher-level biological processes.
